...
<!-- ролик кладётся сюда: docs/timelapse.mp4 — как снять, написано в docs/README.md -->

https://user-images.githubusercontent.com/placeholder/timelapse.mp4

*Муха проходит лабораторную «Мои события №1»: 28 операций, 16 проверок, без промахов.
Как записать свой ролик — в [docs/README.md](docs/README.md).*
...
*Если картинок ещё нет — открой страницы и сними: в `cinema.html` есть кнопка «кадр в PNG»,
остальное через Win+Shift+S. Куда класть — в [docs/README.md](docs/README.md).*
